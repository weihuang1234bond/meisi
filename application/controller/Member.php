...
class Member extends BaseController
{
    ...
    public function addVideo(Request $request)
    {
        ...
        if ($this->request->isPost()) {
            ...
            //new add 2019/4/23 1视频 2为图片 3为资讯
            $this->assign('custom_list',custom_class('1'));    //自定义分类列表
            $this->assign('custom_class',custom_another('1')); //自定义分类别名
            //end
            return view();
        }
    }
    ...
    public function editVideo(Request $request)
    {
        ...
        if ($this->request->isPost()) {
            ...
            $tag_list = db::name('tag')->where('type = 1 and status = 1')->select();
            $class_list = get_resource_class(array('resourceType' => 1));
            $field = 'id,title,thumbnail,gold,tag,class,url,play_time,area_id';
    ...
    public function addNovel(Request $request)
    {
        ...
        if ($this->request->isPost()) {
            ...
            //new add 2019/4/23 1视频 2为图片 3为资讯
            $this->assign('custom_list',custom_class('3'));    //自定义分类列表
            $this->assign('custom_class',custom_another('3')); //自定义分类别名
            //end
            return view();
        }
    ...
    public function editNovel(Request $request)
    {
        ...
        if ($this->request->isPost()) {
            ...
            $tag_list = db::name('tag')->where('type = 3 and status = 1')->select();
            $class_list = get_resource_class(array('resourceType' => 3));
            $field = 'id,title,thumbnail,content,short_info,gold,tag,class,area_id';
    ...
    public function addAtlas(Request $request)
    {
        ...
        //new add 2019/4/23 1视频 2为图片 3为资讯
        $this->assign('custom_list',custom_class('2'));    //自定义分类列表
        $this->assign('custom_class',custom_another('2')); //自定义分类别名
        //end
        return view();
    }
