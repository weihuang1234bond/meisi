<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:40:"./tpl/ms360/member/collection_novel.html";i:1531103066;s:27:"./tpl/ms360/common/top.html";i:1531103068;s:30:"./tpl/ms360/common/header.html";i:1562307170;s:30:"./tpl/ms360/member/common.html";i:1555405552;s:30:"./tpl/ms360/common/bottom.html";i:1531103068;s:30:"./tpl/ms360/common/footer.html";i:1562231560;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="M-content">
            <div class="M-info">
                ...
                <div class="block my-collection">
                    <div class="tab">
                        <a href="<?php echo url('member/collection_video'); ?>">视频</a>
                        <a href="<?php echo url('member/collection_novel'); ?>" class="cur">资讯</a>
                        <a href="<?php echo url('member/collection_img'); ?>">图片</a>
                    </div>
                    <div class="details-box">
                        <div style="display: block;" class="novel">
                            <div class="novel-left">
                                <ul>
                                    <?php if(!(empty($novel_info) || (($novel_info instanceof \think\Collection || $novel_info instanceof \think\Paginator ) && $novel_info->isEmpty()))): if(is_array($novel_info) || $novel_info instanceof \think\Collection || $novel_info instanceof \think\Paginator): $i = 0; $__LIST__ = $novel_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                    <li>
                                        <a href="<?php echo url('novel/show',array('id'=>$v['novel_id'])); ?>">
                                            <div class="novelPic"><img
                                                    src="<?php echo $v['thumbnail']; ?>"/></div>
                                            <div class="novel-box">
                                                <p><?php echo $v['title']; ?></p>
                                                <span class="text"><?php echo (isset($v['short_info']) && ($v['short_info'] !== '')?$v['short_info']:'暂没有短说明'); ?></span>
                                                <div>
                                                    <div class="box-f">
                                                    ...
                                                    <div class="box-r">
                                                        <?php if(is_array($tag[$v['id']]) || $tag[$v['id']] instanceof \think\Collection || $tag[$v['id']] instanceof \think\Paginator): $i = 0; $__LIST__ = $tag[$v['id']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(isset($tags_list[$vo])): ?><span><?php echo $tags_list[$vo]; ?></span><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                        <div class="operate">
                                            <a class="delete" onclick="delcolect(<?php echo $v['id']; ?>,'novel')"><i class="btn fn-shanchu"></i>删除</a>
                                        </div>
                                    </li>
