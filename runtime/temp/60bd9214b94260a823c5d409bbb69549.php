                    ...
                    <div class="t-top">
                        <div class="l-vip">
                            ...
                            <div class="info-vip">
                                ...
                                <p>总K币：<?php echo (isset($member_info['k_money']) && ($member_info['k_money'] !== '')?$member_info['k_money']:'0'); ?></p>
                            </div>
                        </div>
                        <div class="r-vip">
                            <ul>
                                <li><span>提现总额</span><?php echo number_format($total_data['total_tixian'],2); ?></li>
                                <li><span>提成总额</span><?php echo number_format($total_data['total_commission'],2); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
