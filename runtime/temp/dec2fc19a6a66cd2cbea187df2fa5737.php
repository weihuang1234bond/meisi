            ...
            <div class="M-info">
                ...
                <div class="block my-novel">
                            ...
                            <li id="li_<?php echo $vo['id']; ?>">
                                <a class="novel-a" href="<?php echo url('novel/show',array('id'=>$vo['id'])); ?>">
                                    <div class="novelPic">
                                        ...
                                        <?php else: if($vo['is_check'] == 0): ?><span class="btn fn-jiaobiao aspect"><i>审核中</i></span> <?php endif; if($vo['is_check'] == 2): ?><span class="btn fn-jiaobiao"><i>已拒绝</i></span> <?php endif; endif; if($vo['is_check'] == 2): ?>
                    ...
                    <script>
                            ...
                            console.info("http://client.msvodx.com"+$self);
