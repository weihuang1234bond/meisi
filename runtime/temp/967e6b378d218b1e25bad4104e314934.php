<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:28:"./tpl/ms360/novel/lists.html";i:1555991202;s:30:"./tpl/ms360/common/header.html";i:1562559246;s:30:"./tpl/ms360/common/footer.html";i:1562231560;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="vault-top">
            <div class="sort-filter">
                <div class="sort-filter-panel">
                    ...
                    <?php if($area_list): ?>    
                        <div class="item"  style="display:block;"><label><?php echo $classname['name']; ?>：</label>
                            <ul id="area_box">
                                ...
                                <?php if(is_array($area_list) || $area_list instanceof \think\Collection || $area_list instanceof \think\Paginator): $i = 0; $__LIST__ = $area_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <li data="<?php echo $vo['id']; ?>"  <?php if($area_id == $vo['id']): ?>class="current"<?php endif; ?>>
                                        <a href="javascript:;"><?php echo $vo['name']; ?></a>
                                    </li>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                    ...
                    <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <li>
                            <a href="<?php echo url('novel/show',array('id'=>$vo['id'])); ?>">
                                <div class="novelPic"><img src="<?php echo $vo['thumbnail']; ?>" /></div>
                                <div class="novel-box">
