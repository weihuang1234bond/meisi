   ...
   <p>
                        ...
                        <p>
                            ...
                            <span style="margin:0 0 0 20px;">
                                <label>金币 : </label><i class="btn fn-jinbi2"></i><?php echo $info['money']; ?>
                            </span> 
                            <a class="renew" href="<?php echo url('systemPay/recharge',['type'=>1]); ?>">充值</a>
                            <span style="margin:0 0 0 20px;">
                                <label>K币 : </label><?php echo $info['k_money']; ?>
                            </span>
    ...
    <p style="margin-top: 10px;">
        <b>个人主页：</b><a href="<?php echo url('homepage/index',array('uid'=>session('member_id'))); ?>" style="color: #3b9eff;border-bottom: 1px solid #3b9eff;"><?php echo url('homepage/index',array('uid'=>session('member_id'))); ?></a>
    </p>
<p class="exten-box">
<label>链接 : </label>
<input type="text" id="tg-link" class="extension" onmouseover="this.select();" readonly="readonly" value="<?php echo request()->domain(); ?>/share/<?php echo session('member_id'); ?>" >
