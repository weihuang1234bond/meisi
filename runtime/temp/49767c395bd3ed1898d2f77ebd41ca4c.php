<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"./tpl/ms360/mobile/index/login.html";i:1562590089;s:35:"./tpl/ms360/mobile/common/head.html";i:1562590060;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="box">
<link rel="stylesheet" href="__ROOT__/tpl/ms360/mobile/static/css/login.css">
...
<div>
    <div class="login-box">
        ...
        <?php  $longwait=get_sanfanlogin(); if(!(empty($longwait) || (($longwait instanceof \think\Collection || $longwait instanceof \think\Paginator ) && $longwait->isEmpty()))): ?>
        <div class="account-login"><< 返回QQ/微信登录</div>
        <?php endif; ?>
    </div>
    <div class="select-loginType clearfix" style="display: none;">
        <div class="select-box">
            <?php if(is_array($longwait) || $longwait instanceof \think\Collection || $longwait instanceof \think\Paginator): if( count($longwait)==0 ) : echo "" ;else: foreach($longwait as $key=>$vo): if($vo['login_code'] == 'qq'): ?>
            <a class="qq fl" href="<?php echo url('open/login',['code'=>'qq']); ?>">
                <em></em><span>QQ登录</span>
            </a>
            <?php endif; if($vo['login_code'] == 'wechat'): ?>
            <a class="wechat fl" href="<?php echo url('open/login',['code'=>'wechat']); ?>">
                <em></em><span>微信登录</span>
            </a>
            <?php endif; endforeach; endif; else: echo "" ;endif; ?>
        </div>
        <div class="reg-btn"><a href="<?php echo url('index/register'); ?>">注册</a></div>
