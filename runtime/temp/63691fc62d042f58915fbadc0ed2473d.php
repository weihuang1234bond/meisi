...
<div class="s-body">
    ...
    <ul class="select-box">
        ...
        <div class="M-content">
            <div class="M-info">
                <div class="tab">
                    <a href="<?php echo url('member/record_video'); ?>" class="cur">视频</a>
                ...
                <div class="sheet">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><div class="name"><a href="<?php echo url('video/play',array('id'=>$v['video_id'])); ?>" style="color:#3b9eff;"><?php echo $v['title']; ?></a></div></td>
