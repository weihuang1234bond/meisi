        ...
        <div class="M-content">
            <div class="M-info">
                <div class="tab">
                    ...
                    <a href="<?php echo url('member/record_novel'); ?>" class="cur">资讯</a>
                    <a href="<?php echo url('member/record_img'); ?>">图片</a>
                </div>
                ...
                <div class="sheet">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><div class="name"><a href="<?php echo url('novel/show',array('id'=>$v['novel_id'])); ?>" style="color:#3b9eff;"><?php echo $v['title']; ?></a></div></td>
