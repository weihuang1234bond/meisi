        ...
        <div class="M-content">
            <div class="M-info">
                ...
                <div class="block my-collection">
                    <div class="tab">
                        <a href="<?php echo url('member/collection_video'); ?>" class="cur">视频</a>
                        ...
                        <div style="display: block" class="video">
                            <div class="mod-row">
                                ...
                                <div class="mod-col">
                                    ...
                                    <div class="subtitle">
                                        <i class="btn fn-bofang1"></i><?php echo $v['click']; ?>
                                        <var><i class="btn fn-zan2"></i><?php echo $v['good']; ?></var>
                                        <span title="删除" onclick="delcolect(<?php echo $v['id']; ?>,'video')"><i class="btn fn-shanchu"></i></span>
                                    </div>
                                </div>
