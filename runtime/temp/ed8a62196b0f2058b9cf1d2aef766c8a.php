                ...
                <div class="block my-img">
                    ...
                    <div class="img-box">
                        <div class="Atlas-detail">
                            ...
                            <ul id="atlas">
                                <?php if(!(empty($img_list) || (($img_list instanceof \think\Collection || $img_list instanceof \think\Paginator ) && $img_list->isEmpty()))): if(is_array($img_list) || $img_list instanceof \think\Collection || $img_list instanceof \think\Paginator): $i = 0; $__LIST__ = $img_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <li id="img_<?php echo $v['id']; ?>">
                                    <img data-original="<?php echo $v['url']; ?>"
                                         src="<?php echo $v['url']; ?>" alt="<?php echo $v['id']; ?>"/>
                                    <div class="del-btn" style="display: none;" data-id="<?php echo $v['id']; ?>"><i class="btn fn-shanchu"></i></div>

                                    <span class="btn fn-shanchu" data-id="<?php echo $v['id']; ?>" data-atlas_id="<?php echo $v['atlas_id']; ?>" ></span>
                                </li>
    ...
    $(function () {
        ...
        $('.img-btn').click(function () {
            layer.open({
                ...
                skin: 'demo-class',
                anim: 0,
                content: "<?php echo url('member/addimges',array('atlasid'=>$atlasid)); ?>"
            });
        });
        ...
        $(".fn-shanchu").click(function () {
            ...
            layer.open({
                ...
                yes:function () {
                    ...
                    $.post("<?php echo url('api/deleteMyselfImg'); ?>",respData,function(resp){
                        console.log(resp);
