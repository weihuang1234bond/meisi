            ...
            <div class="M-info">
                ...
                <div class="block my-collection">
                    <div class="tab">
                        ...
                        <a href="<?php echo url('member/collection_novel'); ?>">资讯</a>
                        <a href="<?php echo url('member/collection_img'); ?>" class="cur">图片</a>
                    </div>
                    <div class="details-box">
                        <div class="img">
                            ...
                            <ul class="Atlas-box album">
                                ...
                                <li>
                                    <a href="<?php echo url('member/collection_pic',['imgid'=>$v['id']]); ?>">
                                        <img src="<?php if($v['first_img']==='default'): ?>/static/images/images_default.png<?php else: ?><?php echo $v['first_img']; endif; ?>"/>
                                    </a>
                                    <div class="edit-box">
                                        <i class="btn fn-down-bold"></i>
                                        <div class="editBox">
                                            <span onclick="atlas_edit(<?php echo $v['id']; ?>,'<?php echo $v['title']; ?>')"><i class="btn fn-bianji1"></i>编辑</span>
                                            <span onclick="delcolect(<?php echo $v['id']; ?>,'user_atlas')"><i class="btn fn-shanchu"></i>删除</span>
                                        </div>
                                    </div>
...
<script type="text/javascript" src="__ROOT__/tpl/ms360/static/js/viewer.min.js"></script>
<script>
