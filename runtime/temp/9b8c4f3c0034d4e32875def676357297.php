<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./tpl/ms360/mobile/member/member.html";i:1562572089;s:37:"./tpl/ms360/mobile/common/header.html";i:1562589425;s:37:"./tpl/ms360/mobile/common/footer.html";i:1562582439;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    <div>
        <div class="info-box">
            ...
            <div class="info-d">
              <!--这里的输出值是哪里传过来的 common?  可能异步请求过来的-->
        ...
        <div class="M-member">
           <!-- <div class="m-box money info-d">
            ...
            <div class="m-box info-d">
                <div>
                    <a href="<?php echo url('systemPay/recharge'); ?>" class="entrance">充值金币/VIP</a>
                </div>
            </div>
            <div class="m-box ">
