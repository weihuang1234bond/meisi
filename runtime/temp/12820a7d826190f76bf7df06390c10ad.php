<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:35:"./tpl/ms360/mobile/video/lists.html";i:1562572114;s:37:"./tpl/ms360/mobile/common/header.html";i:1562665000;s:37:"./tpl/ms360/mobile/common/footer.html";i:1562665001;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="vault-box">
        <div class="vault-top">
            ...
            <div class="item">
                <label>排序：</label>
                <ul id="orderCode">
                    <li id="lastTime" <?php if($orderCode == 'lastTime'): ?>class="current"<?php endif; ?>><a href="javascript:;">最新</a></li>
                    <li id="hot" <?php if($orderCode == 'hot'): ?>class="current"<?php endif; ?>><a href="javascript:;">最热</a></li>
                    <li id="reco" <?php if($orderCode == 'reco'): ?>class="current"<?php endif; ?>><a href="javascript:;">推荐</a></li>
                </ul>
            </div>
        </div>
