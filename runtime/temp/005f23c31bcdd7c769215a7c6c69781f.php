<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:34:"./tpl/ms360/member/record_img.html";i:1531103066;s:27:"./tpl/ms360/common/top.html";i:1531103068;s:30:"./tpl/ms360/common/header.html";i:1562403770;s:30:"./tpl/ms360/member/common.html";i:1555405552;s:30:"./tpl/ms360/common/bottom.html";i:1531103068;s:30:"./tpl/ms360/common/footer.html";i:1562231560;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="s-body">
    ...
    <ul class="select-box">
        ...
        <div class="M-content">
            <div class="M-info">
                <div class="tab">
                    <a href="<?php echo url('member/record_video'); ?>">视频</a>
                    <a href="<?php echo url('member/record_novel'); ?>">资讯</a>
                    <a href="<?php echo url('member/record_img'); ?>" class="cur">图片</a>
                </div>
                <div class="v-content summary">
                    <div class="t-top">
                        <div class="l-vip">
                            <div class="h-vip">
                        ...
                        <div class="r-vip">
                            <ul>
                                <li><span>总消费</span><?php echo (isset($total_data['total']) && ($total_data['total'] !== '')?$total_data['total']:'0'); ?></li>
                                <li><span>今日消费</span><?php echo (isset($total_data['day']) && ($total_data['day'] !== '')?$total_data['day']:'0'); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="sheet">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><div class="name"><a href="<?php echo url('images/show',array('id'=>$v['atlas_id'])); ?>" style="color:#3b9eff;"><?php echo $v['title']; ?></a></div></td>
                            <td><?php echo $v['gold']; ?></td>
                            <td><?php echo date('Y/m/d h:i:s',$v['view_time']); ?></td>
                    ...
                    <?php else: ?>
                    <div class="not-comment not">您还没有消费记录 ~</div>
                    <?php endif; ?>
                </div>
