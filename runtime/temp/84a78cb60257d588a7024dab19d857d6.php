        ...
        <div class="M-content">
            <div class="M-info">
                <div class="card-box">
                    ...
                    <span style="font-weight: normal;margin-left: 10px;font-size: 14px;">( 我没有卡密，<a  target="_blank" href="<?php echo $seo['buy_cardpassword_uri']; ?>" style="text-decoration: underline;color: #3b9eff;">去购买>></a> )</span>
                </div>
