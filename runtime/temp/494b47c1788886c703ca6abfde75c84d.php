            ...
            <div class="M-info">
                ...
                <div class="sheet">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><div class="name"><?php echo $v['order_sn']; ?></div></td>
                            <td>￥<?php echo $v['price']; ?></td>
                            <td><?php echo date('Y-m-d h:i:s',$v['add_time']); ?></td>
                            <td><?php if($v['buy_type'] == 1): ?>金币充值<?php else: ?>VIP充值<?php endif; ?></td>
                            <td <?php if($v['status'] == 1): ?>class="yes-pay"<?php else: ?>class="not-pay"<?php endif; ?>><?php if($v['status'] == 1): ?>已支付<?php else: ?>未支付<?php endif; ?></td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        </tbody>
                    </table>
