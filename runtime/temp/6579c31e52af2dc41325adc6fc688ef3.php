                        ...
                        <ul class="Atlas-box">
                            ...
                            <li>
                                ...
                                <div class="edit-box">
                                    ...
                                    <div class="editBox">
                                        <span id="edit_<?php echo $vo['id']; ?>"><i class="btn fn-bianji1" ></i>编辑</span>
                                        <span id="delete_<?php echo $vo['id']; ?>"><i class="btn fn-shanchu" ></i>删除</span>
                                    </div>
                                </div>
                                <?php if($vo['status'] != 1): ?>
                                ...
                                <div class="subtitle"><?php echo date('Y-m-d',$vo['update_time']); ?><span><?php echo $vo['click']; ?>次播放</span></div>
                            </li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
    ...
    $(function () {
        ...
        $(".upload-btn a").click(function () {
            layer.open({
                ...
                skin: 'demo-class',
                anim: 0,
                content: "<?php echo url('member/addVideo'); ?>"
            });
        });
        /*我的视频、编辑视频*/
