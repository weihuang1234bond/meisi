<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:28:"./tpl/ms360/index/index.html";i:1562593304;s:30:"./tpl/ms360/common/header.html";i:1562592688;s:29:"./tpl/ms360/common/adver.html";i:1562411089;s:30:"./tpl/ms360/common/footer.html";i:1562231560;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript" src="/tpl/ms360/static/js/index.js"></script>
<script>
...
<div class="copyright-tips">
  <div class="layout-cont"> <span><i class="fa fa-volume-up" aria-hidden="true"></i> &nbsp;公告：</span>
    <ul>
  ...
  <div class="wrapper clearfix">
    <div class="recommend">
      ...
      <ul class="rec-list">
        ...
        <li> <a href="<?php echo url('video/play',array('id'=>$vo['id'])); ?>" title="<?php echo $vo['title']; ?>" target="_blank"> <img src="/tpl/ms360/static/images/404.png" data-original="<?php echo $vo['thumbnail']; ?>">
          <!--<em class="hot"></em>-->
    ...
    <div class="my-live">
      <h3>视频<span>排行</span></h3>
      <div class="my-live-lists">
        <ul>
          ...
          <li> <a href="<?php echo url('video/play',array('id'=>$vo['id'])); ?>" target="_blank">
            <div class="pic"> <img src="/tpl/ms360/static/images/404.png" data-original="<?php echo $vo['thumbnail']; ?>">
              <p class="play"></p>
            </div>
            <div class="txt">
              <p class="title"><?php echo $vo['title']; ?></p>
              <p class="summary">20<?php echo date("y-m-d",$vo['update_time']); ?></p>
              <p class="info"> <span><?php echo $vo['click']; ?></span></p>
            </div>
            </a> </li>
          <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
...
<div class="section alternate">
  <div class="wrapper">
    <h3 class="yxlm"> <img class="ms-icon" src="/tpl/ms360/static/images/lmtb.png" /><?php echo $vo['name']; ?>
	<a class="more" href="/video/lists.html?orderCode=lastTime&tag_id=0&sub_cid=0&cid=<?php echo $vo['id']; ?>">更多&gt;</a> </h3>
    <ul class="live-list clearfix">
      ...
      <li> <a href="<?php echo url('video/play',array('id'=>$v['id'])); ?>" title="<?php echo $v['title']; ?>"> <img src="/tpl/ms360/static/images/404.png" data-original="<?php echo $v['thumbnail']; ?>">
        <p class="title"> <span><?php echo $v['title']; ?></span> <em><?php echo $v['click']; ?></em> </p>
        <p class="desc"> <span>20<?php echo date("y-m-d",$v['update_time']); ?></span> <em><i class="fa fa-usd" aria-hidden="true"></i> <?php echo $v['gold']; ?></em> </p>
        <p class="play"></p>
