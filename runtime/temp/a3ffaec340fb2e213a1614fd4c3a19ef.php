  ...
  <div class="wrapper">
    <div class="classify-tiny limit-height" style="margin-top:10px;border-radius:10px;">
      <div class="tiny-item"> <span class="tiny-name">分类：</span>
        <div class="tiny-list tags-list-click" id="class_box" style="height: auto; overflow: visible;"> <a href="javascript:;" data="0" class="<?php if(empty($cid) || (($cid instanceof \think\Collection || $cid instanceof \think\Paginator ) && $cid->isEmpty())): ?>on<?php endif; ?>">全部</a> <?php if(is_array($class_list) || $class_list instanceof \think\Collection || $class_list instanceof \think\Paginator): $i = 0; $__LIST__ = $class_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> <a data="<?php echo $vo['id']; ?>" href="javascript:;" class="<?php if($cid == $vo['id']): ?>on<?php endif; ?>"><?php echo $vo['name']; ?></a> <?php endforeach; endif; else: echo "" ;endif; ?> </div>
      </div>
      ...
      <div class="tiny-item "> <span class="tiny-name">子类：</span>
        <div class="tiny-list tags-list-click" id="sub_box" style="height: auto; overflow: visible;"> <a href="javascript:;" data="0" class="<?php if(empty($sub_cid) || (($sub_cid instanceof \think\Collection || $sub_cid instanceof \think\Paginator ) && $sub_cid->isEmpty())): ?>on<?php endif; ?>">全部</a> <?php if(is_array($class_sublist) || $class_sublist instanceof \think\Collection || $class_sublist instanceof \think\Paginator): $i = 0; $__LIST__ = $class_sublist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> <a data="<?php echo $vo['id']; ?>" href="javascript:;" class="<?php if($sub_cid == $vo['id']): ?>on<?php endif; ?>"><?php echo $vo['name']; ?></a> <?php endforeach; endif; else: echo "" ;endif; ?> </div>
      </div>
      <?php endif; ?>
      <div class="tiny-item "> <span class="tiny-name">标签：</span>
        <div class="tiny-list tags-list-click" id="tag_box" style="height: auto; overflow: visible;"> <a href="javascript:;" data="0" class="<?php if(empty($tag_id) || (($tag_id instanceof \think\Collection || $tag_id instanceof \think\Paginator ) && $tag_id->isEmpty())): ?>on<?php endif; ?>">全部</a> <?php if(is_array($tag_list) || $tag_list instanceof \think\Collection || $tag_list instanceof \think\Paginator): $i = 0; $__LIST__ = $tag_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> <a data="<?php echo $vo['id']; ?>" href="javascript:;" class="<?php if($tag_id == $vo['id']): ?>on<?php endif; ?>"><?php echo $vo['name']; ?></a> <?php endforeach; endif; else: echo "" ;endif; ?> </div>
      </div>
      <?php if($area_list): ?>
        <div class="tiny-item "> <span class="tiny-name"><?php echo $classname['name']; ?>：</span>
          <div class="tiny-list tags-list-click" id="area_box" style="height: auto; overflow: visible;"> <a href="javascript:;" data="0" class="<?php if(empty($area_id) || (($area_id instanceof \think\Collection || $area_id instanceof \think\Paginator ) && $area_id->isEmpty())): ?>on<?php endif; ?>">全部</a> <?php if(is_array($area_list) || $area_list instanceof \think\Collection || $area_list instanceof \think\Paginator): $i = 0; $__LIST__ = $area_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> <a data="<?php echo $vo['id']; ?>" href="javascript:;" class="<?php if($area_id == $vo['id']): ?>on<?php endif; ?>"><?php echo $vo['name']; ?></a> <?php endforeach; endif; else: echo "" ;endif; ?> </div>
        </div>
      <?php endif; ?>
    </div>
    <br>
