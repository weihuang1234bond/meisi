...
//隐藏模态框
$(document).on('click','span[data-bind-bs="hideModal"]', function () {
var _this = $(this);
_this.parents('div.hkt-win').addClass('hide');
});
$(document).on('click','.show-input > span', function () {
$('.show-input').hide();
$('.nav').fadeIn(800);
$('.click-seek').show();
});
...
$(document).on('keydown','.header-search .txt', function (event) {
...
// 视频模块简单的tabjs
$(document).on('click',".tab-head .a1", function () {
$(this).addClass("active").siblings().removeClass("active");
$("#t2").show();
$("#t1").hide();
});
$(document).on('click',".tab-head .a2", function () {
$(this).addClass("active").siblings().removeClass("active");
$("#t1").show();
$("#t2").hide();
});
// 视频模块手风琴js
$(document).on('click',".v-list .dt-list", function () {
...
//选项卡切换
$(document).on('click',"#tag-toggle a", function () {
...
//登录注册切换
    $(document).on('click', '#login-box .tab-head .t1',function () {
$(this).addClass("active").siblings().removeClass("active");
$("#loginModal-t1").show();
$("#loginModal-t2").hide();
});
    $(document).on('click', '#login-box .tab-head .t2',function () {
$(this).addClass("active").siblings().removeClass("active");
$("#loginModal-t2").show();
$("#loginModal-t1").hide();
});
...
// 点击发送验证码
    $(document).on('click', '#login-box .get-p',function () {
var that = $(this);
// 点击发送验证码后验证手机号码格式
...
// 点击切换验证码
    $(document).on('click', '#login-box .captchaimg',function () {
var unique = new Date().getTime();
var that = $(this);
$.get('/site/captcha', {'refresh': 1, 'v': unique}, function (data) {
...
// 点击登录（或注册）
    $(document).on('click', '#login-box .phone-btn',function () {
var that = $(this);
var data = {};
